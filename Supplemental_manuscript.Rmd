...
ggplot(crcdata,aes(x=solution_proposed_YN, fill=year)) + ggtitle("Solution Proposed: Y=18") + labs(x="Was a solution proposed?") +
  geom_bar(stat = "count", position = "dodge", fill="#99CC99") + theme_minimal() + theme_bw()+
...
ggplot(crcdata,aes(x=solution_implemented_YN, fill=year)) + ggtitle("Solution Implemented: Y=11") + labs(x="Was a solution implemented?") + geom_bar(stat = "count", position = "dodge", fill="#99CC99") + theme_bw()+
  theme(text = element_text(),
        axis.text.x = element_text(angle = 0, hjust = 1)) 
...
ggplot(crcdata,aes(x=S_stakeholder_engagement_YN, fill=year)) + ggtitle("Stakeholder Engagement: YES=92") + labs(x="Were stakeholders engaged?") +
  geom_bar(stat = "count", position = "dodge", fill="#99CC99") + theme_bw()
...
ggplot(crcdata_remove2011, aes(x=year)) + 
  ...
  geom_bar(stat = "count", position = "dodge", fill="#99CC99") + theme_bw()+theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

p <- ggplot(crcdata_remove2011, aes(x = year)) +
  geom_bar(stat = "count", fill = "#99CC99") +
  labs(title = "All FEWS Papers by Year", x = "Year", y = "Count") +
  theme_minimal() +
  theme(
    plot.title  = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)
  ) +
  scale_x_continuous(breaks = sort(unique(crcdata_remove2011$year)))

ggsave(
  filename = "./images/fews_year.png",
  plot = p,
  device = "png",
...
jpeg("./images/rep_tree.jpg", width = 6000, height = 4000, res = 600)  # large canvas + 600 dpi
